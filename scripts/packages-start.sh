...
SERVICES=(
  ...
  "probing-eservice-event-consumer:packages/probing-eservice-event-consumer/.env:3001"
  "probing-tenant-event-consumer:packages/probing-tenant-event-consumer/.env:3002"
